...
namespace Habanero.Testability.Tests
{
    ...
    public class TestValidValueGeneratorTextFile
    {
        ...
        private static ValidValueGeneratorTextFile CreateValueGenerator(string fileName)
        {
            return CreateValueGenerator(fileName, null);
        }

        private static ValidValueGeneratorTextFile CreateValueGenerator(string fileName, IPropDef propDef)
        {
            if (propDef == null)
            {
