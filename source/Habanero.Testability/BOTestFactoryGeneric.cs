...
namespace Habanero.Testability
{
    ...
    public class BOTestFactory<T> : BOTestFactory where T : class, IBusinessObject
    {
        ...
        /// <typeparam name="TReturn"></typeparam>
        /// <param name="propertyExpression"></param>
        /// <param name="validValueGeneratorType"></param>
        public BOTestFactory<T> SetValidValueGenerator<TReturn>(Expression<Func<T, TReturn>> propertyExpression, Type validValueGeneratorType)
        {
            ...
            _validValueGenRegistry.Register(singleValueDef, validValueGeneratorType);
            return this;
        }
        /// <summary>
        ...
        private bool MustGeneratePropValue(ISingleValueDef propDef)
        {
