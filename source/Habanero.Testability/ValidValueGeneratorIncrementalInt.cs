...
namespace Habanero.Testability
{
    ...
    {
        private static Dictionary<IPropDef,int> _latestValue = new Dictionary<IPropDef, int>();
        ...
        private int GenerateValidValue(int? overridingMinValue, int? overridingMaxValue)
        {
            ...
            _latestValue.Remove(base.PropDef);
            ...
            _latestValue.Add(base.PropDef, ++_nextValue);
            return returnValue;
        }
