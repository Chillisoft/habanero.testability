...
namespace Habanero.Testability
{
    ...
    public class BOTestFactory
    {
        ...
        private static readonly ValidValueGeneratorRegistry _validValueGen = new ValidValueGeneratorRegistry();
        private const string DEVELOPER_MESSAGE = "The BOTestFactory class is designed to be used in Testing so it is likely that your classdefs are not being loaded as part of your testing process.";
        ...
        protected static IPropDef GetPropDef(Type type, string propName)
        {
        ...
        protected static IPropDef GetPropDef(IClassDef classDef, string propName)
        {
        ...
        protected static IRelationshipDef GetRelationshipDef(Type type, string relationshipName)
        {
            ...
            ValidateRelationshipDef(type, relationshipDef, relationshipName);
        ...
        {
            IPropDef def = GetPropDef(classDef, propName);
        ...
        public static ValidValueGenerator GetValidValueGenerator(IPropDef propDef)
        {
            ...
            return _validValueGen.Resolve(propDef);
        }
        /// <summary>
        ...
        public virtual void SetPropValueToValidValue(IBOProp boProp)
        {
            ...
            if (boProp.Value != null && !_defaultValueRegistry.IsRegistered(boProp.PropertyName)) return;
        ...
        {
            if (singleRelationship.GetRelatedObject() != null && !_defaultValueRegistry.IsRegistered(singleRelationship.RelationshipName)) return;
        ...
        protected static void ValidateClassDef(Type type)
        {
            ...
            {
                throw new HabaneroDeveloperException(string.Format("The ClassDef for '{0}' does not have any classDefs Loaded", type), DEVELOPER_MESSAGE);
            }
        }
        ...
        private static void ValidateProp(Type type, IPropDef def, string propName)
        {
            if (def == null)
            {
                throw new HabaneroDeveloperException(string.Format("The property '{0}' for the ClassDef for '{1}' is not defined", propName, type), DEVELOPER_MESSAGE);
            }
        }
        ...
        protected static void ValidateRelationshipDef(Type type, IRelationshipDef def, string relationshipName)
        {
            if (def == null)
            {
                throw new HabaneroDeveloperException(string.Format("The relationship '{0}' for the ClassDef for '{1}' is not defined", relationshipName, type), DEVELOPER_MESSAGE);
            }
        }
