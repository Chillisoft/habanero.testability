...
{
    /// <summary>
    /// This is a registry of the ValidValueGenerators Registered for a specific PropertyDefinition <see cref="IPropDef"/>
    ...
    /// in a particular case. Then a Valid Value Generator is registered for that <see cref="IPropDef"/> and the non compulsory prop
    /// will have a value set. For more details see <see cref="BOTestFactory"/>
    /// </summary>
    public class BOPropValueGeneratorRegistry
    {
        private readonly Dictionary<IPropDef, Type> _validValueGenTypesPerPropDef = new Dictionary<IPropDef, Type>();
        private static BOPropValueGeneratorRegistry _boValueGeneratorRegistry;

        private static string GetClassType(IPropDef propDef)
        {
            return propDef.ClassDef == null ? "" : propDef.ClassDef.ClassNameFull;
        }

        private void ClearPreviousInstances(IPropDef propDef)
        {
        ...
        public virtual void Register(IPropDef propDef, Type validValuGenType)
        {
        ...
        /// <param name="propDef"></param>
        /// <returns></returns>
        public bool IsRegistered(IPropDef propDef)
        {
        ...
        public static BOPropValueGeneratorRegistry Instance
        {
            get
            {
                if (_boValueGeneratorRegistry == null) return (_boValueGeneratorRegistry = new BOPropValueGeneratorRegistry());
