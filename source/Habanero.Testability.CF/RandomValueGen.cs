...
*/
        ...
        public static decimal GetRandomDecimal(decimal minValue, decimal maxValue)
        {
            ...
            decimal truncatedRange = range;// Math.Truncate(range);
        ...
        public static Array GetEnumValues(Type enumerationType)
        {
            if (!enumerationType.IsEnum)
                throw new InvalidParameterValueException(enumerationType);
    ...
    {
        public InvalidParameterValueException(Type enumerationType)
            : base(string.Format("The type '{0}' is not an enum", enumerationType))
        {
        }
    }
}