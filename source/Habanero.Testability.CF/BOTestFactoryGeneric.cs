...
/*No linq.Expression in CF
        ...
        /*No linq.Expression in CF
                ...
                public BOTestFactory<T> SetValidValueGenerator<TReturn>(Expression<Func<T, TReturn>> propertyExpression, Type validValueGeneratorType)
                {
                    return SetValidValueGenerator<TReturn>(propertyExpression, validValueGeneratorType, null);
                }
                ...
                /// <param name="validValueGeneratorType">The type of generator which will be instantiated when a valid value is needed</param>
                /// <param name="parameter">An additional parameter to pass to the constructor of the generator</param>
                public BOTestFactory<T> SetValidValueGenerator<TReturn>(Expression<Func<T, TReturn>> propertyExpression, Type validValueGeneratorType, object parameter)
                {
