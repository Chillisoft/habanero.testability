...
namespace Habanero.Testability
{
    ...
    public class BOPropValueGeneratorRegistry
    {
        ...
        {
            Register(propDef, validValuGenType, null);
        }
        ...
        /// <param name="validValuGenType">The type of generator which will be instantiated when a valid value is needed</param>
        /// <param name="parameter">An additional parameter to pass to the constructor of the generator</param>
        public virtual void Register(ISingleValueDef propDef, Type validValuGenType, object parameter)
        {
            ...
            lock (_lockProp)
            {
                ...
                if (_validValueGenTypesPerPropDef.ContainsKey(keyName))
                {
                    ...
                    if (parameter != null)
                    {
                        ...
                        return CreateInstance(validValueGenType, propDef, parameter);
                    }
                    return CreateInstance(validValueGenType, propDef);
                }
        ...
        private static ValidValueGenerator CreateInstance(Type validValueGenType, ISingleValueDef propDef)
        {
            return ReflectionUtilitiesCF.GetInstanceWithConstructorParameters(validValueGenType, new object[] {propDef}) as ValidValueGenerator;
        }

        private static ValidValueGenerator CreateInstance(Type validValueGenType, ISingleValueDef propDef, object parameter)
        {
            return ReflectionUtilitiesCF.GetInstanceWithConstructorParameters(validValueGenType, new[] { propDef, parameter }) as ValidValueGenerator;
        }
        ...
        {
            public ValidValueGeneratorInfo(Type generatorType) : this(generatorType, null)
            {
            }

            public ValidValueGeneratorInfo(Type generatorType, object parameter)
            {
