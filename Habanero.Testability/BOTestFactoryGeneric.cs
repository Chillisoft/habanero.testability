...
namespace Habanero.Testability
{
    ...
    public class BOTestFactory<T> : BOTestFactory where T : class, IBusinessObject
    {
        ...
        {
            IPropDef propDef = GetPropDef(propertyExpression);
        ...
        private static IPropDef GetPropDef<TReturn>(Expression<Func<T, TReturn>> propertyExpression)
        {
            string propertyName = GetPropertyName(propertyExpression);
            return GetPropDef(typeof(T), propertyName);
        }
