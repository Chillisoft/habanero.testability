...
namespace Habanero.Testability.Tests
{
    ...
    public class TestBOFactory
    {
        ...
        [Test]
        public void Test_GetValidValueGenerator_WhenHasRegisteredCustomGen_ShouldRetCustomGen()
        {
            //---------------Set up test pack-------------------
        ...
        [Test]
        public void Test_GetValidValueGenerator_WhenHasRegisteredCustomGen_WhenCallFromDiffFactoryInstance_ShouldRetCustomGenerator()
        {
            //---------------Set up test pack-------------------
            var type = typeof(FakeBO);
            ClassDef.ClassDefs.Add(type.MapClass());
        ...
        [Test]
        public void TestAccept_GetValidValue_WhenHasRegisteredCustomGen_WhenCallFromDiffFactoryInstance_ShouldRetValueFromCustomGenerator()
        {
            //---------------Set up test pack-------------------
            var type = typeof(FakeBO);
            ClassDef.ClassDefs.Add(type.MapClass());
            var boTestFactory = new BOTestFactory<FakeBO>();
            boTestFactory.SetValidValueGenerator(bo => bo.NonCompulsoryString, typeof(ValidValueGeneratorIncrementalInt));
        ...
        [Test]
        public void TestAccept_GetValidValue_WhenHasRegisteredCustomGen_WhenHasDefault_ShouldUseValueFromCustomGenerator()
        {
            //---------------Set up test pack-------------------
